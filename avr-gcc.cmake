...
if(AVR_UPLOADTOOL_VERBOSE)
    set(AVR_UPLOADTOOL_BASE_OPTIONS ${AVR_UPLOADTOOL_BASE_OPTIONS} -v)
endif()
...
function(add_avr_executable EXECUTABLE_NAME)
    ...
    add_custom_target(
            ...
            avrdude ${AVR_UPLOADTOOL_BASE_OPTIONS} ${AVR_UPLOADTOOL_OPTIONS}
            -U flash:w:${hex_file}
...
function(avr_generate_fixed_targets)
    ...
    add_custom_target(
            get_status
            avrdude ${AVR_UPLOADTOOL_BASE_OPTIONS} -P ${AVR_UPLOADTOOL_PORT} -n -v
    ...
    add_custom_target(
            get_fuses
            avrdude ${AVR_UPLOADTOOL_BASE_OPTIONS} -P ${AVR_UPLOADTOOL_PORT} -n
            -U lfuse:r:-:b
            -U hfuse:r:-:b
    ...
    add_custom_target(
            set_fuses
            avrdude ${AVR_UPLOADTOOL_BASE_OPTIONS} -P ${AVR_UPLOADTOOL_PORT}
